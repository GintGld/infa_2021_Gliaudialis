...
def car(x, y):
    '''
    Маленькая синяя машина, смотращая влево
...
def carh1(x, y):
    '''
    Большая синяя машина, смотрящая вправо
    x, y - координаты левого нижнего угла
    Рисует по очереди:
    Выхлопную трубу, саму машину, два окна, два колеса
    '''
...
def carh2(x, y):
    '''
    Большая синяя машина, смотрящая вправо
    x, y - координаты правого нижнего угла
    Рисует по очереди:
    Выхлопную трубу, саму машину, два окна, два колеса
    '''
